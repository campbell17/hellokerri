  ...
  return (
    <main className="min-h-screen relative">
      ...
      <motion.button
        ...
        className="hidden fixed top-4 right-4 text-gray-500 hover:text-white transition-colors z-[0] w-10 h-10 items-center justify-center rounded-full bg-gray-900/50 hover:bg-gray-900/80 backdrop-blur-sm border border-white/10"
      >
