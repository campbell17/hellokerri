  ...
  return (
    <>
      ...
      <AnimatePresence>
        {!selectedProject && (
          <motion.button
            ...
            onClick={onClose}
            className="fixed right-4 lg:right-[49%] top-4 lg:top-7 text-white/60 hover:text-white transition-colors z-[60] w-10 h-10 flex items-center justify-center rounded-full bg-gray-900/50 hover:bg-gray-900/80 backdrop-blur-sm border border-white/10"
          >
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-[100vw] lg:w-[50%] bg-gray-100/95 lg:bg-gray-100/95 backdrop-blur-md border-l border-gray-200/20 shadow-xl z-50"
      >
